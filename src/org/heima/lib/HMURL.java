...
public class HMURL {
	 ...
	 public static String BASE_HTTP = "http://192.168.21.36:8080/ChatServer";//测试地址：公司
//	 public static String BASE_HTTP = "http://192.168.0.102:8080/ChatServer";//测试地址：Home
	 public static String BASE_HM_HOST = "192.168.21.36";//测试ip 公司
//	 public static String BASE_HM_HOST = "192.168.0.102";//测试ip home
